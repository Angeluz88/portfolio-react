...
const PortfolioBox = (props: PortfolioProps) => {
    ...
    return (  
      <div className="p-4  border border-teal-50 rounded-xl">
        ...
        className="w-full md:w-[200px] rounded-xl h-auto" />

        <div className="flex gap-5 mt-5">
            <Link href={urlGithub} target="_blank" className="p-2 transition 
            duration-150 rounded-lg bg-slate-500 hover:bg-slate-500/80">
                GitHub
            </Link>
            <Link href={urlDemo} target="_blank" className="p-2 transition 
